...
X = struct('mean', mean(main_scores),...
    'lower_quartile', quantile(main_scores, 0.25),...
    'median', median(main_scores),...
    'upper_quartile', quantile(main_scores, 0.75),...
    'max', max(main_scores),...
    'min', min(main_scores) );
S = json.dump(X); % S is simply a string, so I can play around with it...
S = strcat( '"', 'official', '":', S, ',');
...
X = struct('mean', mean(beat_scores),...
    'lower_quartile', quantile(beat_scores, 0.25),...
    'median', median(beat_scores),...
    'upper_quartile', quantile(beat_scores, 0.75),...
    'max', max(beat_scores),...
    'min', min(beat_scores) );
S = json.dump(X); % S is simply a string, so I can play around with it...
S = strcat( '"', 'beat', '":', S, ',');
...
X = struct('mean', mean(phase_scores),...
    'lower_quartile', quantile(phase_scores, 0.25),...
    'median', median(phase_scores),...
    'upper_quartile', quantile(phase_scores, 0.75),...
...
X = struct('mean', mean(tempo_scores),...
    'lower_quartile', quantile(tempo_scores, 0.25),...
    'median', median(tempo_scores),...
    'upper_quartile', quantile(tempo_scores, 0.75),...
...
X = struct('mean', mean(scores_for_sum_of_tempo_scores),...
    'lower_quartile', quantile(scores_for_sum_of_tempo_scores, 0.25),...
    'median', median(scores_for_sum_of_tempo_scores),...
    'upper_quartile', quantile(scores_for_sum_of_tempo_scores, 0.75),...
